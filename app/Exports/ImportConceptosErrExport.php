...
class ImportConceptosErrExport implements FromCollection, WithHeadings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return ImportConceptosArcaErr::all([
            'id_empresa',
            'nombre_archivo',
            'tamanio_archivo',
            'detalle',
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Errores de la importación');
