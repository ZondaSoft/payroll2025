...
const props = defineProps({
    legajo: {
        type: Object,
        default: () => ({ id: null, codigo: '', numero: '', detalle: '' }),
    },
    agregar: {
      type: Boolean,
      required: true
...
const determineActionRoute = () => {
  if (props.agregar) {
    ...
    return '/sicoss/localidades/add';
  } else if (props.edicion) {
    return `/sicoss/localidades/edit/${form.id}`;
  } else {
    return '/sicoss/localidades'; // Ruta predeterminada o de error
  }
};
...
const submit = () => {
    let ruta = 'sicoss.localidades.update';

    if (usePage().props.agregar) {
        ruta = 'sicoss.localidades.store';
...
const borrar = () => {
    ...
    router.delete(route('sicoss.localidades.destroy', id), {
        preserveScroll: true,
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
                    ...
                    <div class="d-flex flex-column justify-content-center" v-if="!agregar && !edicion && form.id">
                        <div class="btn-group" role="group" aria-label="First group">
                            ...
                            <Link
                                :href="route('sicoss.localidades.previous', form.id)"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <Link
                                :href="route('sicoss.localidades.next', form.id)"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <Link
                                :href="route('sicoss.localidades.last')"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <a type="button" href="/sicoss/localidades/search" class="btn btn-outline-secondary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Buscar ...">
                    ...
                    <div v-if="agregar || edicion" class="d-flex align-content-center flex-wrap gap-4">
                        ...
                        <Link
                            ...
                            :href="route('sicoss.localidades.index')"
                    ...
                    <div v-else class="d-flex align-content-center flex-wrap gap-4">
                        <Link
                            :href="route('sicoss.localidades.create')"
                        ...
                        <Link
                            ...
                            :href="route('sicoss.localidades.edit', props.legajo.id)"
                            class="btn btn-outline-secondary"
                            @click="setFocus"
                            >
                            Modificar
