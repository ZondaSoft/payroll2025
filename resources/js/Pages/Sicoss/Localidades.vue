        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="app-ecommerce">
                ...
                <FormHeader
                    ...
                    :edicion="edicion"
                    :form-id="form.id"
                    titulo="Sicoss - Localidades"
                    :ruta-create="route('sicoss.localidades.create')"
                    :ruta-edit="form.id ? route('sicoss.localidades.edit', form.id) : null"
                    :ruta-first="route('sicoss.localidades.first')"
                    :ruta-previous="form.id ? route('sicoss.localidades.previous', form.id) : null"
                    :ruta-next="form.id ? route('sicoss.localidades.next', form.id) : null"
                    :ruta-last="route('sicoss.localidades.last')"
                    :ruta-search="route('sicoss.localidades.search')"
                    :ruta-index="route('sicoss.localidades.index')"
                    :on-submit="submit"
                />
                <!-- END HEAD Y BOTONES -->
