        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="app-ecommerce">
                ...
                <FormHeader
                    ...
                    :edicion="edicion"
                    :form-id="form.id"
                    titulo="Sicoss - Modalidades"
                    :ruta-create="route('sicoss.modalidades.create')"
                    :ruta-edit="form.id ? route('sicoss.modalidades.edit', form.id) : null"
                    :ruta-first="route('sicoss.modalidades.first')"
                    :ruta-previous="form.id ? route('sicoss.modalidades.previous', form.id) : null"
                    :ruta-next="form.id ? route('sicoss.modalidades.next', form.id) : null"
                    :ruta-last="route('sicoss.modalidades.last')"
                    :ruta-search="route('sicoss.modalidades.search')"
                    :ruta-index="route('sicoss.modalidades.index')"
                    :on-submit="submit"
                />
                <!-- END HEAD Y BOTONES -->
