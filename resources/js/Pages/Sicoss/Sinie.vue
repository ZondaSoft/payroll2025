        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="app-ecommerce">
                ...
                <FormHeader
                    ...
                    :edicion="edicion"
                    :form-id="form.id"
                    titulo="Sicoss - Código de siniestro"
                    :ruta-create="route('sicoss.siniestros.create')"
                    :ruta-edit="form.id ? route('sicoss.siniestros.edit', form.id) : null"
                    :ruta-first="route('sicoss.siniestros.first')"
                    :ruta-previous="form.id ? route('sicoss.siniestros.previous', form.id) : null"
                    :ruta-next="form.id ? route('sicoss.siniestros.next', form.id) : null"
                    :ruta-last="route('sicoss.siniestros.last')"
                    :ruta-search="route('sicoss.siniestros.search')"
                    :ruta-index="route('sicoss.siniestros.index')"
                    :on-submit="submit"
                />
                <!-- END HEAD Y BOTONES -->
