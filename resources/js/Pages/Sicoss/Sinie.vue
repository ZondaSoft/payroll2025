...
const determineActionRoute = () => {
  if (props.agregar) {
    ...
    return '/sicoss/siniestros/add';
  } else if (props.edicion) {
    return `/sicoss/siniestros/edit/${form.id}`;
  } else {
    return '/sicoss/siniestros'; // Ruta predeterminada o de error
  }
};
...
const submit = () => {
    let ruta = 'sicoss.siniestros.update';

    if (usePage().props.agregar) {
        ruta = 'sicoss.siniestros.store';
...
const borrar = () => {
    ...
    router.delete(route('sicoss.siniestros.destroy', id), {
        preserveScroll: true,
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
                    ...
                    <div class="d-flex flex-column justify-content-center" v-if="!agregar && !edicion && form.id">
                        <div class="btn-group" role="group" aria-label="First group">
                            ...
                            <Link
                                :href="route('sicoss.siniestros.previous', form.id)"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <Link
                                :href="route('sicoss.siniestros.next', form.id)"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <Link
                                :href="route('sicoss.siniestros.last')"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <a type="button" href="/sicoss/siniestros/search" class="btn btn-outline-secondary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Buscar ...">
                    ...
                    <div v-if="agregar || edicion" class="d-flex align-content-center flex-wrap gap-4">
                        ...
                        <Link
                            ...
                            :href="route('sicoss.siniestros.index')"
                    ...
                    <div v-else class="d-flex align-content-center flex-wrap gap-4">
                        <Link
                            :href="route('sicoss.siniestros.create')"
                        ...
                        <Link
                            ...
                            :href="route('sicoss.siniestros.edit', props.legajo.id)"
                            class="btn btn-outline-secondary"
                            @click="setFocus"
                            >
                            Modificar
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating form-floating-outline">
                                                        <input
                                                            ...
                                                            class="form-control"
                                                            placeholder="Detalle del cód. de siniestro"
                                                            autocomplete="off"
