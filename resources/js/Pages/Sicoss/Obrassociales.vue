                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
                    ...
                    <div class="d-flex flex-column justify-content-center" v-if="!agregar && !edicion && form.id">
                        <div class="btn-group" role="group" aria-label="First group">
                            ...
                            <Link
                                :href="route('sicoss.obras.previous', form.id)"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <Link
                                :href="route('sicoss.obras.next', form.id)"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <a type="button" href="/sicoss/obras/search" class="btn btn-outline-secondary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Buscar ...">
                    ...
                    <div v-else class="d-flex align-content-center flex-wrap gap-4">
                        <Link
                            :href="route('sicoss.obras.create')"
                        ...
                        <Link
                            ...
                            :href="route('sicoss.obras.edit', props.legajo.id)"
                            class="btn btn-outline-secondary"
                            @click="setFocus"
                            >
                            Modificar
