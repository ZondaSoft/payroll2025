...
const determineActionRoute = () => {
  if (props.agregar) {
    ...
    return '/sicoss/actividades/add';
  } else if (props.edicion) {
    return `/sicoss/actividades/edit/${form.id}`;
  } else {
    return '/sicoss/actividades'; // Ruta predeterminada o de error
  }
};
...
const submit = () => {
    let ruta = 'sicoss.actividades.update';

    if (usePage().props.agregar) {
        ruta = 'sicoss.actividades.store';
...
const borrar = () => {
    ...
    router.delete(route('sicoss.actividades.destroy', id), {
        preserveScroll: true,
            ...
            <div class="app-ecommerce">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
                    ...
                    <div v-if="agregar" class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1">Agregar Actividad</h4>
                    </div>
                    <!-- Sección de edición -->
                    ...
                    <div class="d-flex flex-column justify-content-center" v-if="!agregar && !edicion && form.id">
                        <div class="btn-group" role="group" aria-label="First group">
                            ...
                            <Link
                                :href="route('sicoss.actividades.previous', form.id)"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <Link
                                :href="route('sicoss.actividades.next', form.id)"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <Link
                                :href="route('sicoss.actividades.last')"
                                class="btn btn-outline-secondary waves-effect"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                            ...
                            <a type="button" href="/sicoss/actividades/search" class="btn btn-outline-secondary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Buscar ...">
                    ...
                    <div v-if="agregar || edicion" class="d-flex align-content-center flex-wrap gap-4">
                        ...
                        <Link
                            ...
                            :href="route('sicoss.actividades.index')"
                    ...
                    <div v-else class="d-flex align-content-center flex-wrap gap-4">
                        <Link
                            :href="route('sicoss.actividades.create')"
                        ...
                        <Link
                            ...
                            :href="route('sicoss.actividades.edit', props.legajo.id)"
                            class="btn btn-outline-secondary"
                            @click="setFocus"
                            >
                            Modificar
