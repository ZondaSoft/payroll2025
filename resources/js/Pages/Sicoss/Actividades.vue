        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="app-ecommerce">
                ...
                <FormHeader
                    ...
                    :edicion="edicion"
                    :form-id="form.id"
                    titulo="Sicoss - Actividades"
                    :ruta-create="route('sicoss.actividades.create')"
                    :ruta-edit="form.id ? route('sicoss.actividades.edit', form.id) : null"
                    :ruta-first="route('sicoss.actividades.first')"
                    :ruta-previous="form.id ? route('sicoss.actividades.previous', form.id) : null"
                    :ruta-next="form.id ? route('sicoss.actividades.next', form.id) : null"
                    :ruta-last="route('sicoss.actividades.last')"
                    :ruta-search="route('sicoss.actividades.search')"
                    :ruta-index="route('sicoss.actividades.index')"
                    :on-submit="submit"
                    @delete="() => {}"
                />
                <!-- END HEAD Y BOTONES -->
