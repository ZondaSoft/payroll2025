...
@section('content')
    ...
    <form method="post" id="formImportar" name="formImportar" action="{{ route('sicoss.importar2') }}"
                ...
                <div class="col">
                    ...
                    <div class="card mb-12">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div id="mensaje-procesando" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%, -50%);
                            ...
                            <nav class="navbar navbar-expand-sm navbar-light bg-white mt-8 pt-4">
                                <div class="container-fluid mt-6" style="margin-left: 20px; margin-right: 20px;">
                                    <div id="wizard" style="height: 600px;">
                                        ...
                                        <section class="pt-2" hidden>
                                            ...
                                            <div class="col-md-12 pl-0 mt-5">
                                                <div class="form-row">
                                                    ...
                                                    <div class="d-flex mt-4 mb-2" style="gap: 1rem;">
                                                        <div style="flex: 1;">
                                                            <label class="col-form-label"
                                                                style="padding-top: 0px">Empresa</label>
                                                            <select class="form-control selected2" id="empresa"
                                                                name="empresa"
                                                                style="padding-left: 16px;padding-right: 16px;padding-top: 6px;padding-bottom: 6px;height: 36px;"
                                                                onchange="document.getElementById('empresa_cuit').value = this.options[this.selectedIndex].dataset.cuit || ''">

                                                                @foreach ($empresas as $empresa)
                                                                    <option value="{{ $empresa->id }}"
                                                                        data-cuit="{{ $empresa->cuit }}">{{ $empresa->detalle }}
                                                                    </option>
                                                                @endforeach
                                                        ...
                                                        <div style="width: 200px;">
                                                            <label class="col-form-label"
                                                                style="padding-top: 0px">CUIT</label>
                                                            <input class="form-control" type="text" id="empresa_cuit"
                                                                disabled
                                                                style="padding-left: 16px;padding-right: 16px;padding-top: 6px;padding-bottom: 6px;height: 36px;background-color: #ced4da;"
                                                                value="{{ $empresas->first()?->cuit }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3 mb-2 mr-4">
                                                        ...
                                                        <div class="input-group " id="divPeriodo" data-provide=""
                                                            keyboardNavigation="false" title="Ingrese un Nro. legajo">

                                                            <input class="form-control" type="text" id="periodo2"
                                                                name="periodo2" autocomplete="off" maxlength="7"
                                                                style="padding-left: 16px;padding-right: 16px;padding-top: 6px;padding-bottom: 6px;width: 110px"
                                                                value="{{ old('periodo2', $periodo2) }}" autofocus>

                                                            <ul class="parsley-errors-list filled" id="labelError1"
                                        ...
                                        <section class="pt-2" hidden>
                                            ...
                                            <p>Seleccione el libro de excel generado en ARCA</p>
                                            ...
                                            <div class="form-row mt-5">
                                                ...
                                                <div class="col-lg-4 mb-2 mr-4" hidden>
                                                    ...
                                                    <div class="input-group " id="divPeriodo" data-provide=""
                                                        ...
                                                        <input class="form-control" type="text" id="nom_arch"
                                                            name="nom_arch" autocomplete="off" maxlength="255"
                                                            style="padding-left: 16px;padding-right: 16px;padding-top: 6px;padding-bottom: 6px;"
                                                            value="{{ old('nom_arch', $legajo->nom_arch) }}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 mb-2 mr-4" hidden>
                                                    ...
                                                    <div class="input-group " id="divPeriodo" data-provide=""
                                                        ...
                                                        <input class="form-control" type="text" id="tam_arch"
                                                            name="tam_arch" autocomplete="off" maxlength="255"
                                                            style="padding-left: 16px;padding-right: 16px;padding-top: 6px;padding-bottom: 6px;"
                                                            value="{{ old('tam_arch', $legajo->tam_arch) }}" readonly>
                                                    </div>
                                                </div>

                                                <div class="form-group col-lg-12 row align-items-center">
                                                    <div class="col-md-12">
                                                        <label for="file">Generado en : Declaración en línea → Consultar
                                                            DDJJ generada →
                                                            Seleccionar todos los CUILES → Descargar los CUILES
                                                            (normalmente llamado Nomina_...xlsx):</label>
                                                        <input type="file" name="file" id="file"
                                                            class="form-control mt-3 @error('file') is-invalid @enderror"
                                                            required
                                                            accept=".xlsx,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" />
                                                        <small class="form-text text-muted">El archivo debe ser una planilla
                                                            de excel con el formato correcto.</small>
                                                    </div>
                                                    <div class="alert alert-danger ml-3" role="alert" hidden>
                                                        <strong>Cuidado</strong> Debe seleccionar un archivo válido.
                                                    </div>

                                                    <div class="invalid-feedback d-block ml-3" id="fileError"
                                        ...
                                        <section class="pt-2" hidden>
                                            ...
                                            <h2 class="section-heading mb-5" id="titleFinish" name="titleFinish">Procesando
                                                importación...</h2>
                                            ...
                                            <a class="btn btn-primary" id="btn-ok" name="btn-ok" type="button" hidden mt-5
                                                mb-4 href="{{ route('sicoss.importar.exportarOk') }}">Descargar registros
                                                importados
                                            </a>
                                            ...
                                            <a class="btn btn-danger mt-4" id="btn-err" name="btn-err" type="button" hidden
                                                mb-2 href="{{ route('sicoss.importar.exportarErr') }}">Descargar registros
                                                rechazados
                                            </a>
                ...
                <div class="modal-dialog">
                    <form class="modal-content">
                            ...
                            <div class="row">
                                <div class="col mb-6 mt-1">
                                    ...
                                    <div class="alert d-flex align-items-center alert-warning mb-0 h6" role="alert">
                                        <span class="alert-icon rounded-4"><i
                                                class="ri-information-line ri-22px"></i></span>

                                        <span> Esta seguro de eliminar el registro seleccionado? <br> No podra recuperar el
                                            registro borrado... </span>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <a href="{{ asset('/sicoss/importar/delete') }}/{{ $legajo->id }}" type="button"
                                class="btn btn-danger waves-effect waves-light" style="color: white">Borrar</a>
    ...
    <div class="modal fade" id="modalErrorImport" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title text-white"><i class="ri-error-warning-line ri-22px me-2"></i>Error en la
                        importación</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="modalErrorImportBody"></div>
                </div>
                <div class="modal-footer">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validarArchivo(file) {
                ...
                if (!allowedExtensions.includes(extension)) {
                    errores.push('El archivo debe ser un libro Excel en formato .xlsx. Si tiene un archivo .xls debe convertirlo a .xlsx antes de importarlo.');
                }
                ...
                fetch("{{ route('sicoss.importar2') }}", {
                    ...
                    .then(response => {
                        if (!response.ok) {
                            return response.json().then(data => {
                                // Extraer mensajes de error de validación Laravel
                                let mensajes = [];
                                if (data.errors) {
                                    Object.values(data.errors).forEach(errs => {
                                        errs.forEach(e => mensajes.push(e));
                                    });
                                } else if (data.message) {
                                    mensajes.push(data.message);
                                } else if (data.msg) {
                                    mensajes.push(data.msg);
                                }
                                throw { mensajes: mensajes.length ? mensajes : ['Error desconocido en el servidor'] };
                            });
                        }
                    ...
                    .catch(error => {
                        ...
                        if (error.mensajes) {
                            ...
                            mensajes = ['Error al subir el archivo: ' + error.message];
                        }

                        // Cambiar título del paso 3
                        document.getElementById('titleFinish').textContent = 'Importación fallida.';

                        // Ocultar botones de descarga y botón Anterior (con delay para que el wizard termine de renderizar)
                        setTimeout(() => {
                            document.getElementById('btn-ok').setAttribute('hidden', true);
                            document.getElementById('btn-ok').style.display = 'none';
                            document.getElementById('btn-err').setAttribute('hidden', true);
                            document.getElementById('btn-err').style.display = 'none';

                            const btnAnterior = document.querySelector('#wizard .actions a[href="#previous"]');
                            if (btnAnterior) btnAnterior.parentElement.style.display = 'none';
                        }, 300);

                        // Mostrar modal de error
                        const body = document.getElementById('modalErrorImportBody');
                        body.innerHTML = mensajes.map(m => '<p class="mb-2">' + m + '</p>').join('');
                        const modal = new bootstrap.Modal(document.getElementById('modalErrorImport'));
                        modal.show();

                        if (callback) callback(false, mensajes.join(', '));
                    });
            };
