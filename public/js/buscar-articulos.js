...
$(function () {
  ...
  if (dt_basic_table.length) {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            //   '</ul>' +
            //   '</div>' +
              '<a href="/artic-insumos/' + $id + '" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="ri-edit-box-line"></i></a>'
            );
          }
        }
      ],
          ...
          buttons: [
            ...
            // },
            {
              ...
              action: function (e, dt, node, config) {
                window.location.href = '/artic-insumos/export';
              },
              exportOptions: {
                columns: [3, 4, 5, 6, 7],
                // prevent avatar to be display
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Buscar artículos</h5>');
  }
