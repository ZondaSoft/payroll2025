...
$(function () {
  ...
  var urlNewReq = '/delivery/add/';
  var urlEditReq = '/delivery/edit/';
  ...
  if (dt_invoice_table.length) {
    ...
    var dt_invoice = dt_invoice_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<a href="' + urlEditReq + full['id'] + '" data-bs-toggle="tooltip" class="btn btn-sm btn-icon btn-text-secondary waves-effect waves-light rounded-pill"  data-bs-placement="top" title="Editar comprobante"><i class="ri-edit-2-line ri-20px"></i></a>' +
              '<div class="dropdown">' +
              ...
              '<a href="' + urlEditReq + full['id'] + '" class="dropdown-item">Editar</a>' +
            ...
            // '<a href="javascript:;" class="btn btn-sm btn-icon btn-text-secondary waves-effect waves-light rounded-pill delete-record" data-bs-toggle="modal" data-bs-target="#backDropModal" data-id=' + full['id'] + ' onclick="setModalId(this)" data-bs-placement="top" title="Anular comprobante"><i class="ri-delete-bin-7-line ri-20px"></i></a>' +
          }
        }
      ],
      order: [[0, 'desc']],
      ...
      buttons: [
        {
          text: '<i class="ri-add-line ri-16px me-md-2 align-baseline"></i><span class="d-md-inline-block d-none">Registrar nueva entrega</span>',
