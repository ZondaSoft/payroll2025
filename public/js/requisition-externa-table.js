...
$(function () {
    ...
    var urlNewReq = '/requisition-externa/add/';
    var urlEditReq = '/requisition-externa/edit/';
  ...
  if (dt_invoice_table.length) {
    ...
    var urlToload = '/requisitionexterna/json';
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              $name +
              '</p></a>' +
              '<small class="text-truncate">Codigo: ' +
              $requisitor +
              '</small>' +
              '</div>' +
              '</div>';
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if ($oc === null) {
                ...
                return '<span class="text-heading"><a href="/ordencpa/numero/' + $oc + '"/>' + $oc + '</a></span>';
