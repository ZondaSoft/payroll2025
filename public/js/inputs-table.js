...
$(function () {
  ...
  var urlNewReq = '/input-form/add/';
  var urlEditReq = '/input-form/edit/';
  ...
  if (dt_invoice_table.length) {
    ...
    var dt_invoice = dt_invoice_table.DataTable({
      ...
      buttons: [
        {
          text: '<i class="ri-add-line ri-16px me-md-2 align-baseline"></i><span class="d-md-inline-block d-none">Registrar nuevo comprobante</span>',
