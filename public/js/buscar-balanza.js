...
$(function () {
  ...
  if (dt_invoice_table.length) {
    ...
    var dt_invoice = dt_invoice_table.DataTable({
      ajax: '/balanza/json2',    // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $id = full['nro_infor'];
            // Creates full output for row
            var $row_output = '<a href="/balanza/' + $id + '"/><span>' + $id + '</span></a>';
            return $row_output;
          }
        },
        {
        ...
        },
        {
          ...
          targets: 5,
          render: function (data, type, full, meta) {
            var $peso_n = full['peso_n'];
            return '<span>' + $peso_n + '</span>';
          }
        },
        {
          // Fecha
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if ($obs1 === 0) {
              ...
              return '<span class="text-heading">' + $obs1 + '</span>';
            }
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<a href="/balanza/' + full['nro_infor'] + '" data-bs-toggle="tooltip" class="btn btn-sm btn-icon btn-text-secondary waves-effect waves-light rounded-pill ri-check-line" data-bs-placement="top" title="Seleccionar"><i class="ri-check-line-7-line ri-20px"></i></a>' +
            //   '<div class="dropdown">' +
            ...
            //   '<a href="/balanza/' + full['id'] + '" class="dropdown-item">Editar</a>' +
            //   '<a href="/balanza/add" class="dropdown-item">Duplicar</a>' +
            //   '</div>' +
            //   '</div>' +
              '</div>'
            );
