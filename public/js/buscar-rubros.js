...
$(function () {
  ...
  if (dt_basic_table.length) {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              '<a href="/rubros-insumos/' + $id + '" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="ri-edit-box-line"></i></a>'
            );
          }
        }
      ],
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Buscar rubros</h5>');
  }
