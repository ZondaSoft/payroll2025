...
$(function () {
  ...
  if (dt_basic_table.length) {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            //   '<li><a href="/proveedores/' + $id + '" class="dropdown-item">Detalles</a></li>' +
            //   '<div class="dropdown-divider"></div>' +
            //   '<li><a href="/proveedores/' + $id + '" class="dropdown-item text-danger delete-record">Borrar</a></li>' +
            //   '</ul>' +
            //   '</div>' +
              '<a href="/proveedores/' + $id + '" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="ri-edit-box-line"></i></a>'
            );
          }
        }
      ],
          ...
          buttons: [
            ...
            // },
            {
              ...
              action: function (e, dt, node, config) {
                window.location.href = '/proveedores/export';
              },
              exportOptions: {
                columns: [3, 4, 5, 6, 7],
                // prevent avatar to be display
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Buscar proveedores</h5>');
  }
