...
$(function () {
  ...
  if (dt_basic_table.length) {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              // '<li><a href="/tasks/' + $id + '" class="dropdown-item">Detalles</a></li>' +
              // '<div class="dropdown-divider"></div>' +
              // '<li><a href="/tasks/' + $id + '" class="dropdown-item text-danger delete-record">Borrar</a></li>' +
              // '</ul>' +
              // '</div>' +
              '<a href="/tasks/' + $id + '" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="ri-edit-box-line"></i></a>'
            );
          }
        }
      ],
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Buscar tareas y reparaciones</h5>');
  }
