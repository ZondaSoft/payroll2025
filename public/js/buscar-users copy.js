        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if ($vehiculo === 0) {
              ...
              return '<span class="text-heading">' + $vehiculo + '</span>';
            }
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" data-bs-toggle="tooltip" class="btn btn-sm btn-icon btn-text-secondary waves-effect waves-light rounded-pill delete-record" data-bs-placement="top" title="Borrar informe"><i class="ri-delete-bin-7-line ri-20px"></i></a>' +
              '<div class="dropdown">' +
              ...
              '<a href="javascript:;" class="dropdown-item">Duplicar</a>' +
              '</div>' +
              '</div>' +
              '</div>'
            );
